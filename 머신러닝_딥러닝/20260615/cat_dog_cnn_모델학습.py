...
test_dir = '/home/sophie/tf_env/머신러닝_딥러닝/20260615/cnn_cats_and_dogs_dataset/test'
...
train_data_gen = train_img_gen.flow_from_directory(
    ...
    class_mode = 'binary',   # 이진 분류할 때 => 'binary' , if 다중분류면 => 'categorical'
...
checkpoint_cb = ModelCheckpoint('./catdog_bestmodel.keras', save_best_only=True )
...
record = model.fit(train_data_gen, validation_data = test_data_gen, 
                    steps_per_epoch = 800, validation_steps = 40,
                    verbose=1, epochs = 50,
