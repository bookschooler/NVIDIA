...
# 모델 학습
multi_lrmodel.fit(train_poly , train_y) # ==> 최적의 가중치, 편향이 찾아짐

# 모델 성능 평가
print('acc : ', multi_lrmodel.score(test_poly, test_y) ) # 0.97
...
# 예측
# 길이가 30인 농어의 무게를 예측?
pred = multi_lrmodel.predict([[900,30]])
print('pred : ', pred) #  [382.21135986]
...
plt.savefig('fish_mutilinear.jpeg')